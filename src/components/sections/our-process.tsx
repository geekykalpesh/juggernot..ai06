      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            A proven methodology that transforms enterprises through strategic phases with measurable results
          </p>
        </div>
        ...
        <div className="flex justify-center items-center mb-8">
          <div className="flex items-center space-x-2 px-4 py-2 bg-[#F3F4F6] dark:bg-[#1C1C1F] rounded-full">
            ...
            <span className="text-sm font-medium text-[#27272A] dark:text-[#FAFAFA]">18-Month Journey</span>
          </div>
        </div>
            ...
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-10 h-10 bg-[#27272A] dark:bg-[#FAFAFA] rounded-lg flex items-center justify-center mx-auto mb-2">
                  <span className="text-sm font-bold text-[#FAFAFA] dark:text-[#27272A]">{milestone.month}</span>
                </div>
                <div className="text-xs font-medium text-[#27272A] dark:text-[#FAFAFA]">Month {milestone.month}</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">{milestone.label}</div>
              </div>
            ))}
          </div>
        </div>
